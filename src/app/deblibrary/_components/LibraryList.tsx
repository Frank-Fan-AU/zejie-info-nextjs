import { Design_LIBRARY, UI_LIBRARY, UTIL_LIBRARY } from "@/common/constant/library";
...
const LibraryList = () => {
    ...
    return (
        <div className='flex flex-col'>
            ...
            <h1 className='text-2xl font-bold my-5'>Utils</h1>
            <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3'>
                {utilsList.map((item: LibraryProps, index: number) => (
                    <LibraryCard {...item} key={index} />
                ))}
            </div>
