...
const Resume = () => {
  const RESUME_URL = 'https://docs.google.com/document/d/1akSpsFtsrn92Zwf12nCiDzJ8mJUYcK1dCr8hsldGmyw/edit?tab=t.0';
  ...
  return (
    <div className='space-y-5'>
      ...
      <GoogleDocsEmbed src='https://docs.google.com/document/d/1akSpsFtsrn92Zwf12nCiDzJ8mJUYcK1dCr8hsldGmyw/edit?tab=t.0' />
    </div>
  );
};
